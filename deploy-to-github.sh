#!/bin/bash
# Script to deploy the organized project structure to GitHub
# This script helps organize and push the Module 5 project to the Module-6_Project_6 repository
